...
public class TranslateVisitor implements ast.Visitor {
	...
	public void visit(ast.exp.False e) {
		this.exp = new codegen.C.exp.Num(0);//there is no boolean type in C code
	}
	...
	public void visit(ast.exp.True e) {
		this.exp = new codegen.C.exp.Num(1);//there is no boolean type in C code
	}
	...
	public void visit(ast.stm.Block s) {
		java.util.LinkedList<T> st = new LinkedList<T>();
		for (ast.stm.T stm : s.stms) {
			stm.accept(this);
			st.add(this.stm);
		}
		this.stm = new codegen.C.stm.Block(st);
		return;
	}
	...
	public void visit(ast.type.Boolean t) {
		this.type = new codegen.C.type.Int();//there is no boolean type in C code
	}
